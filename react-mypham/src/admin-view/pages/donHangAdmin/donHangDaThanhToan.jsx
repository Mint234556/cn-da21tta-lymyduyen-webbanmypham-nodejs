...
const DonHang_DaThanhToan_Admin = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(`${api}/don-hang/da-thanh-toan`); // Đảm bảo URL đúng với API của bạn
...
export default DonHang_DaThanhToan_Admin;
